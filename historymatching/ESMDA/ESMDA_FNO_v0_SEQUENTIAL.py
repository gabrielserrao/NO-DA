...
NePx = 100 #ensemble members for the Proxy
...
for alpha in alphas:
    ...
    destDir= os.path.join(curDir,f'simulations_SEQ100/it{l}')
    ...
    #conditional for all l>0 unless the last iteration
    else:
    #read MGrid from the previous iteration
        destDir= os.path.join(curDir,f'simulations_SEQ100/it{l-1}')
