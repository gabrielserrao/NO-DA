...
if __name__ == '__main__':
    run_proxy(data_folder = '/samoa/data/smrserraoseabr/NO-DA/historymatching/ESMDA/prior_geomodels',
              output_folder = '.',
              Ne=2,
              path_model = '/samoa/data/smrserraoseabr/NO-DA/runs/FNO_3d_N800.0_ep110_m18_w128_b10_INPUT_Por_Perm_gas_rate_OUTPUT_Pressure/FNO_3d_N800.0_ep110_m18_w128_b10_INPUT_Por_Perm_gas_rate_OUTPUT_Pressure_model.pt',
              device='cuda')
