...
obsValues = np.array([obsValues[i][1:] for i in range(len(obsValues))])
...
NeHf = 10 #ensemble members for the High Fidelity foward model
...
path_case = f'AAAAAREF501_PARALLEL_simulations_Loc_{Localization}_PERM_Nit{ESMDA_its}_HF{NeHf}_PX{NePx}'
